...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lots_lot', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['owners.Owner'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lot.billing_account'
        db.add_column(u'lots_lot', 'billing_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['owners.BillingAccount'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.owner'
        db.delete_column(u'lots_lot', 'owner_id')

        # Deleting field 'Lot.billing_account'
        db.delete_column(u'lots_lot', 'billing_account_id')
    ...
    models = {
        u'lots.lot': {
            ...
            'billing_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['owners.BillingAccount']", 'null': 'True', 'blank': 'True'}),
