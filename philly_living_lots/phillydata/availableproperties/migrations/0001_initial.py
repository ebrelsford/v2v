...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'availableproperties_availableproperty', (
            ...
            ('asset_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
    ...
    models = {
        u'availableproperties.availableproperty': {
            ...
            'asset_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
