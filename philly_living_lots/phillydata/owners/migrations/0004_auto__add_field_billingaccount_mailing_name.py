...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillingAccount.mailing_name'
        db.add_column(u'owners_billingaccount', 'mailing_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillingAccount.mailing_name'
        db.delete_column(u'owners_billingaccount', 'mailing_name')
