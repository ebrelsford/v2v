...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.land_use_area'
        db.add_column(u'lots_lot', 'land_use_area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['landuse.LandUseArea'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.land_use_area'
        db.delete_column(u'lots_lot', 'land_use_area_id')
