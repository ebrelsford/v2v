...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lots_lot', 'city_council_district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boundaries.Boundary'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.city_council_district'
        db.delete_column(u'lots_lot', 'city_council_district_id')
