...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.known_use'
        db.add_column(u'lots_lot', 'known_use',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Use'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lot.known_use'
        db.delete_column(u'lots_lot', 'known_use_id')
