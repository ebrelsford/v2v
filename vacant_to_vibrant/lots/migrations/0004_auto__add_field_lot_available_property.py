...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.available_property'
        db.add_column(u'lots_lot', 'available_property',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['availableproperties.AvailableProperty'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.available_property'
        db.delete_column(u'lots_lot', 'available_property_id')
