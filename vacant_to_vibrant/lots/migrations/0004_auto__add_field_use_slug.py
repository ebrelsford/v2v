...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Use.slug'
        db.add_column(u'lots_use', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Use.slug'
        db.delete_column(u'lots_use', 'slug')
