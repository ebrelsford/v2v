...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lot.group'
        db.add_column(u'lots_lot', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.LotGroup'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Lot.group'
        db.delete_column(u'lots_lot', 'group_id')
