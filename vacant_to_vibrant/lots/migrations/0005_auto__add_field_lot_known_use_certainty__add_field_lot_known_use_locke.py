...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.known_use_certainty'
        db.add_column(u'lots_lot', 'known_use_certainty',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Lot.known_use_locked'
        db.add_column(u'lots_lot', 'known_use_locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.known_use_certainty'
        db.delete_column(u'lots_lot', 'known_use_certainty')

        # Deleting field 'Lot.known_use_locked'
        db.delete_column(u'lots_lot', 'known_use_locked')
    ...
    models = {
        ...
        u'lots.lot': {
            ...
            'city_council_district': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['boundaries.Boundary']", 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lots.LotGroup']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'known_use': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lots.Use']", 'null': 'True', 'blank': 'True'}),
            'known_use_certainty': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            ...
            'zoning_district': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['zoning.BaseDistrict']", 'null': 'True', 'blank': 'True'})
        },
        u'lots.lotgroup': {
