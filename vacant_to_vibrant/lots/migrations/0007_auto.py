...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field licenses on 'Lot'
        db.create_table(u'lots_lot_licenses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lot', models.ForeignKey(orm[u'lots.lot'], null=False)),
            ('license', models.ForeignKey(orm[u'licenses.license'], null=False))
        ))
        db.create_unique(u'lots_lot_licenses', ['lot_id', 'license_id'])


    def backwards(self, orm):
        # Removing M2M table for field licenses on 'Lot'
        db.delete_table('lots_lot_licenses')
