...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.polygon_area'
        db.add_column(u'lots_lot', 'polygon_area',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Lot.polygon_width'
        db.add_column(u'lots_lot', 'polygon_width',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.polygon_area'
        db.delete_column(u'lots_lot', 'polygon_area')

        # Deleting field 'Lot.polygon_width'
        db.delete_column(u'lots_lot', 'polygon_width')
