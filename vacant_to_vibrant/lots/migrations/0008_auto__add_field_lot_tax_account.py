...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.tax_account'
        db.add_column(u'lots_lot', 'tax_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taxaccounts.TaxAccount'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.tax_account'
        db.delete_column(u'lots_lot', 'tax_account_id')
