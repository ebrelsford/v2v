...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.steward_inclusion_opt_in'
        db.add_column(u'lots_lot', 'steward_inclusion_opt_in',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.steward_inclusion_opt_in'
        db.delete_column(u'lots_lot', 'steward_inclusion_opt_in')
