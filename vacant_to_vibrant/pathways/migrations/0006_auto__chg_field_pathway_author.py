...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pathway.author'
        db.alter_column(u'pathways_pathway', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Pathway.author'
        raise RuntimeError("Cannot reverse this migration. 'Pathway.author' and its values cannot be restored.")
