...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pathway.name'
        db.alter_column(u'pathways_pathway', 'name', self.gf('django.db.models.fields.CharField')(default='name', max_length=256))

        # Changing field 'Pathway.slug'
        db.alter_column(u'pathways_pathway', 'slug', self.gf('django.db.models.fields.SlugField')(default='name', max_length=256))

    def backwards(self, orm):

        # Changing field 'Pathway.name'
        db.alter_column(u'pathways_pathway', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Pathway.slug'
        db.alter_column(u'pathways_pathway', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=256, null=True))
