...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pathway.private_owners'
        db.add_column(u'pathways_pathway', 'private_owners',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Pathway.public_owners'
        db.add_column(u'pathways_pathway', 'public_owners',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field specific_public_owners on 'Pathway'
        db.create_table(u'pathways_pathway_specific_public_owners', (
        ...
        db.create_unique(u'pathways_pathway_specific_public_owners', ['pathway_id', 'owner_id'])


    def backwards(self, orm):
        # Deleting field 'Pathway.private_owners'
        db.delete_column(u'pathways_pathway', 'private_owners')

        # Deleting field 'Pathway.public_owners'
        db.delete_column(u'pathways_pathway', 'public_owners')

        # Removing M2M table for field specific_public_owners on 'Pathway'
        db.delete_table('pathways_pathway_specific_public_owners')
    ...
    models = {
        ...
        u'pathways.pathway': {
            ...
            'private_owners': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'public_owners': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '256'}),
            'specific_public_owners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['owners.Owner']", 'symmetrical': 'False'}),
