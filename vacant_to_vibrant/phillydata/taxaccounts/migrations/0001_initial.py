...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'taxaccounts_taxaccount', (
            ...
            ('owner_name2', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('amount_delinquent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True)),
            ...
            ('exempt_abate_assessment', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True)),
            ('market_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True)),
