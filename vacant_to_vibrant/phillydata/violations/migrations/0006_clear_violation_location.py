...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Clear the violation_location field"""
        orm['violations.Violation'].objects.all().update(violation_location=None)
        orm['violations.ViolationLocation'].objects.all().delete()

    def backwards(self, orm):
        "Write your backwards methods here."
        raise Exception('Too late--no going back!')
    ...
    models = {
        ...
        u'violations.violation': {
            ...
            'violation_location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['violations.ViolationLocation']", 'null': 'True'}),
