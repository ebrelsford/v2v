...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Violation.case_number'
        db.add_column(u'violations_violation', 'case_number',
                      self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Violation.case_number'
        db.delete_column(u'violations_violation', 'case_number')
    ...
    models = {
        ...
        u'violations.violation': {
            ...
            'case_number': ('django.db.models.fields.CharField', [], {'max_length': '30', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
