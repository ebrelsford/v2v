    ...
    example_response = """
{
    ...
    def test_parcel_kwargs(self):
        data = json.loads(self.example_response)
        kwargs = _water_parcel_kwargs(data)
    ...
    def test_get_or_create_water_accounts(self):
        data = json.loads(self.example_response)
        water_parcel = _get_or_create_water_parcel(data)
        water_accounts = _get_or_create_water_accounts(data, water_parcel)
