...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'phillyorganize_organizer', (
            ...
            ('receive_text_messages', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('vision', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'phillyorganize', ['Organizer'])

        # Adding model 'Watcher'
        db.create_table(u'phillyorganize_watcher', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ...
        db.send_create_signal(u'phillyorganize', ['Watcher'])


    def backwards(self, orm):
        # Deleting model 'Organizer'
        db.delete_table(u'phillyorganize_organizer')

        # Deleting model 'Watcher'
        db.delete_table(u'phillyorganize_watcher')
