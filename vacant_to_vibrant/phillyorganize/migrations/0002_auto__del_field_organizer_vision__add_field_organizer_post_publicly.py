...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organizer.vision'
        db.delete_column(u'phillyorganize_organizer', 'vision')

        # Adding field 'Organizer.post_publicly'
        db.add_column(u'phillyorganize_organizer', 'post_publicly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Organizer.vision'
        db.add_column(u'phillyorganize_organizer', 'vision',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Organizer.post_publicly'
        db.delete_column(u'phillyorganize_organizer', 'post_publicly')
    ...
    models = {
        ...
        u'phillyorganize.organizer': {
            ...
            'post_publicly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
