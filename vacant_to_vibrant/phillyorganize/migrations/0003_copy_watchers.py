...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Move Watcher objects to Organizer objects."""

        # Assume all watchers are individuals
        organizer_type = orm['organize.OrganizerType'].objects.get(
            name__iexact='individual'
        )

        # Copy everyone over
        for watcher_values in orm['phillyorganize.Watcher'].objects.values():
            del watcher_values['id']
            organizer = orm['phillyorganize.Organizer'](**watcher_values)
            organizer.post_publicly = False
