...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StewardNotification.part_of_nga'
        db.delete_column(u'steward_stewardnotification', 'part_of_nga')

        # Deleting field 'StewardProject.part_of_nga'
        db.delete_column(u'steward_stewardproject', 'part_of_nga')


    def backwards(self, orm):
        # Adding field 'StewardNotification.part_of_nga'
        db.add_column(u'steward_stewardnotification', 'part_of_nga',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StewardProject.part_of_nga'
        db.add_column(u'steward_stewardproject', 'part_of_nga',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
