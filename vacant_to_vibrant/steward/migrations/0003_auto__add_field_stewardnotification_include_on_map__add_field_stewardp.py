...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StewardNotification.include_on_map'
        db.add_column(u'steward_stewardnotification', 'include_on_map',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StewardProject.include_on_map'
        db.add_column(u'steward_stewardproject', 'include_on_map',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StewardNotification.include_on_map'
        db.delete_column(u'steward_stewardnotification', 'include_on_map')

        # Deleting field 'StewardProject.include_on_map'
        db.delete_column(u'steward_stewardproject', 'include_on_map')
