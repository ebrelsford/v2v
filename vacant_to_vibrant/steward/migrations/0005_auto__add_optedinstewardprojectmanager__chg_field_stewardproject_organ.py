...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OptedInStewardProjectManager'
        db.create_table(u'steward_optedinstewardprojectmanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'steward', ['OptedInStewardProjectManager'])


        # Changing field 'StewardProject.organizer'
        db.alter_column(u'steward_stewardproject', 'organizer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyorganize.Organizer'], null=True))

    def backwards(self, orm):
        # Deleting model 'OptedInStewardProjectManager'
        db.delete_table(u'steward_optedinstewardprojectmanager')


        # User chose to not deal with backwards NULL issues for 'StewardProject.organizer'
        raise RuntimeError("Cannot reverse this migration. 'StewardProject.organizer' and its values cannot be restored.")
