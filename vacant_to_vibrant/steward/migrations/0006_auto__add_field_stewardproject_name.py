...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StewardProject.name'
        db.add_column(u'steward_stewardproject', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StewardProject.name'
        db.delete_column(u'steward_stewardproject', 'name')
