...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StewardNotification.share_contact_details'
        db.add_column(u'steward_stewardnotification', 'share_contact_details',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StewardProject.share_contact_details'
        db.add_column(u'steward_stewardproject', 'share_contact_details',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StewardNotification.share_contact_details'
        db.delete_column(u'steward_stewardnotification', 'share_contact_details')

        # Deleting field 'StewardProject.share_contact_details'
        db.delete_column(u'steward_stewardproject', 'share_contact_details')
