...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StewardProject.pilcop_garden_id'
        db.add_column(u'steward_stewardproject', 'pilcop_garden_id',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StewardProject.pilcop_garden_id'
        db.delete_column(u'steward_stewardproject', 'pilcop_garden_id')
    ...
    models = {
        ...
        u'steward.stewardproject': {
            ...
            'pilcop_garden_id': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
