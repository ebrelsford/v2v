...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyFormEntry.form'
        db.add_column(u'survey_surveyformentry', 'form',
    ...
    models = {
        ...
        u'survey.surveyformentry': {
            ...
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'survey_entries'", 'to': u"orm['forms.Form']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
